...
nf-tips-dataset-64 = Сектор: Hex is open source! If there's a change you want to make, or a simple item you want to add, then try contributing to the game. It's not as hard as you'd think it is.
...
nf-tips-dataset-111 = Remember, Colossus Central has a 256m wide safe-zone. It's forbidden to steal from ships or ID's within that limit! Read the rules for more information.
